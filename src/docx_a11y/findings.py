...
class Finding:
    ...
    Attributes:
        rule_id:      stable rule identifier, e.g. "title-missing".
        sc:           WCAG success criterion, e.g. "1.3.1".
        severity:     critical | serious | moderate | minor.
        location:     human-readable element location (e.g. "paragraph[4]",
                      "table[0] row[0] cell[1]", "docProps/core.xml").
        description:  what is wrong.
        evidence:     raw evidence (attribute values, ratios, ...).
